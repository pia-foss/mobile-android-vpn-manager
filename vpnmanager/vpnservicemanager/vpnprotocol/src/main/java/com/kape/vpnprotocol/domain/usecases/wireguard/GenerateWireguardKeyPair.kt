...
internal class GenerateWireguardKeyPair(
    private val wireguardKeyPair: IWireguardKeyPair,
) : IGenerateWireguardKeyPair {

    // region IGenerateWireguardKeyPair
    override suspend fun invoke(): Result<IWireguardKeyPair> =
