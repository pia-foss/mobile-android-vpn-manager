...
internal class StopConnection(
    private val serviceManager: IServiceManager,
) : IStopConnection {

    // region IStopConnection
    override suspend operator fun invoke(disconnectReason: DisconnectReason): Result<Unit> =
        serviceManager.stop(disconnectReason)
    // endregion
}
