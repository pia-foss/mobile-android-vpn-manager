...
internal object GivenController {
    ...
    fun getOptimalServerController(
        setServerList: ISetServerList = GivenUsecase.setServerList(),
        getOptimalServer: IGetOptimalServer = GivenUsecase.getOptimalServer(),
    ): IGetOptimalServerController =
        GetOptimalServerController(
