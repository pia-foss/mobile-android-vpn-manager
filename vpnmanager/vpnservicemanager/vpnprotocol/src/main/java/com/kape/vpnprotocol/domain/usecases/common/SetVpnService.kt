...
internal class SetVpnService(
    private val cacheService: ICacheService,
) : ISetVpnService {

    // region ISetVpnService
    override suspend fun invoke(vpnProtocolService: VPNProtocolService): Result<Unit> =
        cacheService.setVpnProtocolService(vpnProtocolService = vpnProtocolService)
    // endregion
}
