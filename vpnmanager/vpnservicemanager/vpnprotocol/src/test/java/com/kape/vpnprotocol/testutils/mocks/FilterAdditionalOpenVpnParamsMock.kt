...
internal class FilterAdditionalOpenVpnParamsMock(
    private val shouldSucceed: Boolean,
) : IFilterAdditionalOpenVpnParams {

    // region IFilterAdditionalOpenVpnParams
    override suspend fun invoke(config: VPNProtocolConfiguration): Result<VPNProtocolConfiguration> {
