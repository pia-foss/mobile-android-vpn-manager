...
internal class StartWireguardConnectionControllerMock : IStartWireguardConnectionController {
    ...
    override suspend fun invoke(
        ...
        invocationsCounter++
        return Result.success(GivenModel.vpnProtocolServerPeerInformation())
    }
    // endregion
}
