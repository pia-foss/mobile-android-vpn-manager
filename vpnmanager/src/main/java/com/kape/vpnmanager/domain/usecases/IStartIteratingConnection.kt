...
internal interface IStartIteratingConnection {
    suspend operator fun invoke(serverList: ServerList, vpnProtocol: VPNManagerProtocolTarget): Result<ServerPeerInformation>
}
