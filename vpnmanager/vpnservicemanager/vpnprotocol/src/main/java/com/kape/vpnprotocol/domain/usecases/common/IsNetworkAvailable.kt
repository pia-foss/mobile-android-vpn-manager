...
internal class IsNetworkAvailable(
    private val connectivity: IConnectivity,
) : IIsNetworkAvailable {

    // region IIsNetworkAvailable
    override suspend fun invoke(host: String): Result<Unit> =
        connectivity.isNetworkReachable(host = host)
    // endregion
}
