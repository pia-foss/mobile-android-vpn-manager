...
internal class SetWireguardAddKeyResponse(
    private val cacheKeys: ICacheWireguardKeys,
) : ISetWireguardAddKeyResponse {

    //region ISetWireguardAddKeyResponse
    override suspend fun invoke(wireguardAddKeyResponse: WireguardAddKeyResponse): Result<Unit> =
        cacheKeys.setAddKeyResponse(wireguardAddKeyResponse = wireguardAddKeyResponse)
    // endregion
}
