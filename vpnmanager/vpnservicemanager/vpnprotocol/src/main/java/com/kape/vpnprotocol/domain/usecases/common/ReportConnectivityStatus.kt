...
internal class ReportConnectivityStatus(
    private val cacheProtocol: ICacheProtocol,
) : IReportConnectivityStatus {

    // region IReportConnectivityStatus
    override suspend fun invoke(connectivityStatus: VPNManagerConnectionStatus): Result<Unit> =
        cacheProtocol.reportConnectivityStatus(connectivityStatus = connectivityStatus)
    // endregion
}
