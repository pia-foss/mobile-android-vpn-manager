...
internal class CreateOpenVpnProcessConnectedDeferrable(
    private val cacheOpenVpn: ICacheOpenVpn,
) : ICreateOpenVpnProcessConnectedDeferrable {

    // region ICreateOpenVpnProcessConnectedDeferrable
    override suspend fun invoke(): Result<Unit> =
        cacheOpenVpn.createOpenVpnProcessConnectedDeferrable()
    // endregion
}
