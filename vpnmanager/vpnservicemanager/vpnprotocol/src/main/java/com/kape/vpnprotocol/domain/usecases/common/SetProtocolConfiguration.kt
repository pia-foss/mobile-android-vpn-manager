...
internal class SetProtocolConfiguration(
    private val cacheProtocol: ICacheProtocol,
) : ISetProtocolConfiguration {

    // region ISetProtocolConfiguration
    override suspend fun invoke(protocolConfiguration: VPNProtocolConfiguration): Result<Unit> =
        cacheProtocol.setProtocolConfiguration(protocolConfiguration = protocolConfiguration)
    // endregion
}
