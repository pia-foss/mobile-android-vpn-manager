...
internal class SetServiceFileDescriptorMock(
    private val shouldSucceed: Boolean,
) : ISetServiceFileDescriptor {

    // region ISetServiceFileDescriptor
    override suspend fun invoke(serviceFileDescriptorProvider: ServiceConfigurationFileDescriptorProvider): Result<Unit> {
