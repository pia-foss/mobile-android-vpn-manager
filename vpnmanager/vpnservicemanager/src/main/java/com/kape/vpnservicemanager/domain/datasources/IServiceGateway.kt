...
internal interface IServiceGateway {

    /**
     * @return `Result<VPNServiceServerPeerInformation>`.
     */
    suspend fun startService(): Result<VPNServiceServerPeerInformation>

    /**
     * @return `Result<Unit>`.
     */
    suspend fun stopService(disconnectReason: DisconnectReason): Result<Unit>
}
